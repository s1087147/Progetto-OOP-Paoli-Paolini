...
/**
 * Classe che gestisce la statistica sul valore minimo della distanza tra la località di invio del tweet e
 * il capoluogo scelto.
...
public class GeoMinDistance {
	...
	/**
	 * Metodo che applica la statistica sul valore minimo della distanza tra la località di invio del tweet
